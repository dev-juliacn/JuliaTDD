...
$ docker run --rm juliacn/ubuntu:julia.pycall julia -i -e 'using Pkg;Pkg.add(Pkg.PackageSpec(url="https://github.com/dev-juliacn/JuliaTDD", rev="pycall"));Pkg.test("JuliaTDD");'
 ...
 Resolving package versions...
  ...
  [527c4dd8] + JuliaTDD v0.1.0 #pycall (https://github.com/dev-juliacn/JuliaTDD)
  Updating `~/.julia/environments/v1.0/Manifest.toml`
  [527c4dd8] + JuliaTDD v0.1.0 #pycall (https://github.com/dev-juliacn/JuliaTDD)
   Testing JuliaTDD
    Status `/tmp/tmp705bBA/Manifest.toml`
  ...
  Updating git-repo `https://github.com/JuliaRegistries/General.git`
 Resolving package versions...
  Updating `/tmp/tmp705bBA/Project.toml`
 [no changes]
  Updating `/tmp/tmp705bBA/Manifest.toml`
 [no changes]
Julia Version 1.0.0
...
Environment:
  ...
  JULIA_VERSION = 1.0.0
  JULIA_LOAD_PATH = @:/tmp/tmp705bBA
Hello World!The test works.
Let's do something useful.
   Testing PyCall
 Resolving package versions...
    Status `/tmp/tmpFrdIOO/Manifest.toml`
  [34da2185] Compat v1.0.1
  [8f4d0f93] Conda v1.0.1+ #master (https://github.com/JuliaPy/Conda.jl)
  [682c06a0] JSON v0.19.0
  [1914dd2f] MacroTools v0.4.4
